...
- Best method overall on locked test by mean log loss: rolling_14 (log loss 0.4543).
- Best P1/P2 method: han_arw (log loss 0.4544).
- Han ARW selected windows used across prediction days: ['expanding', 'rolling_14'].
- Differentiable Forgetting learned half-life ranged 8.37-74.40 days (mean 61.30).
