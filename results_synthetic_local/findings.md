...
- Best baseline on locked test by mean log loss: rolling_14 (log loss 0.4543).
- Validation-selected window on dev period: h=expanding.
- Hindsight best fixed window took 3 distinct value(s) across the 35 test days: ['expanding', 'rolling_14', 'rolling_7'].
