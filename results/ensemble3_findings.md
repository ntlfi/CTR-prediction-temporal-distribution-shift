...
- ensemble3 locked-test log loss 0.6070; final-day mean weights [('m2', 0.32), ('m5b', 0.34), ('m5b_hs', 0.34)], top expert m5b_hs.
- M5b-high-smooth (standalone) locked-test log loss 0.6070.
- Best method overall on locked test (including ensemble3): m5_multiscale_gate (log loss 0.6070).
