...
- ensemble3 locked-test log loss 0.4188; final-day mean weights [('m2', 0.01), ('m5b', 0.01), ('m5b_hs', 0.98)], top expert m5b_hs.
- M5b-high-smooth (standalone) locked-test log loss 0.4172.
- Best method overall on locked test (including ensemble3): m5b_high_smooth (log loss 0.4172).
