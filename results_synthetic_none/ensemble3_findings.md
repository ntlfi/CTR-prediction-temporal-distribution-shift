...
- ensemble3 locked-test log loss 0.3116; final-day mean weights [('m2', 0.32), ('m5b', 0.32), ('m5b_hs', 0.36)], top expert m5b_hs.
- M5b-high-smooth (standalone) locked-test log loss 0.3114.
- Best method overall on locked test (including ensemble3): expanding (log loss 0.3107).
