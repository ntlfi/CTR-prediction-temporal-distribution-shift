...
- Best method overall on locked test by mean log loss: han_arw (log loss 0.3936).
- Best P1/P2 method: han_arw (log loss 0.3936).
- Han ARW selected windows used across prediction days: ['expanding', 'rolling_14', 'rolling_3', 'rolling_7'].
- Differentiable Forgetting learned half-life ranged 2.18-74.40 days (mean 59.45).
