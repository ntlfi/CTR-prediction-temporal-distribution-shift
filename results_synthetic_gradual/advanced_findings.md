...
- Best method overall on locked test by mean log loss: rolling_14 (log loss 0.3543).
- Best P1/P2 method: han_arw (log loss 0.3543).
- Han ARW selected windows used across prediction days: ['expanding', 'rolling_14'].
- Differentiable Forgetting learned half-life ranged 7.63-102.17 days (mean 42.17).
